...
.method protected applyMeizuStyle(Landroid/app/AlertDialog;)V
    ...
    .local v17, "idView":Landroid/view/View;
    if-nez v17, :cond_0

    return-void

    :cond_0
    const v24, #android:id@extractArea#t
    ...
    .local v14, "extractArea":Landroid/view/View;
    if-eqz v14, :cond_1
    ...
    .local v15, "extractAreaVisible":Z
    :goto_0
    if-eqz v15, :cond_1
    ...
    .end local v15    # "extractAreaVisible":Z
    ...
    const v24, #android:id@buttonPanel#t
    ...
    const v24, #android:id@customPanel#t
    ...
    const v24, #android:id@contentPanel#t
    ...
    const v24, #android:id@topPanel#t
    ...
    .local v22, "topPanel":Landroid/view/View;
    ...
    :cond_2
    :goto_5
    invoke-virtual/range {v21 .. v21}, Landroid/view/View;->requestLayout()V
    ...
    .end local v10    # "contentPanel":Landroid/view/View;
    .end local v11    # "contentVisible":Z
    .end local v12    # "customPanel":Landroid/view/View;
    .end local v13    # "customVisible":Z
    .end local v21    # "parentPanel":Landroid/view/View;
    .end local v22    # "topPanel":Landroid/view/View;
    .end local v23    # "topVisible":Z
    :cond_3
    const/4 v15, 0x0
    ...
    .restart local v10    # "contentPanel":Landroid/view/View;
    .restart local v12    # "customPanel":Landroid/view/View;
    .restart local v21    # "parentPanel":Landroid/view/View;
    .restart local v22    # "topPanel":Landroid/view/View;
    :cond_4
    const/16 v23, 0x0

    .restart local v23    # "topVisible":Z
    goto :goto_1
    ...
    .local v19, "lpFrame":Landroid/widget/FrameLayout$LayoutParams;
    const/16 v24, 0x11
    ...
    .local v20, "lpParent":Landroid/widget/FrameLayout$LayoutParams;
    const/16 v24, -0x2
