...
.method public clear()V
    ...
    invoke-static {v0}, Landroid/app/FlymeWallpaperManagerInjector;->openFlymeDefaultWallpaper(Landroid/content/Context;)Ljava/io/InputStream;
...
.method public getBuiltInDrawable(IIZFFI)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v5}, Landroid/app/FlymeWallpaperManagerInjector;->openFlymeDefaultWallpaper(Landroid/content/Context;)Ljava/io/InputStream;
...
.method public setBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;ZII)I
    ...
    invoke-static {p0}, Landroid/app/FlymeWallpaperManagerInjector;->isFlymeChildrenMode(Landroid/app/WallpaperManager;)Z

    move-result v0

    if-eqz v0, :cond_lyme_0
...
.method public setResource(II)I
    ...
    invoke-static/range {p0 .. p0}, Landroid/app/FlymeWallpaperManagerInjector;->isFlymeChildrenMode(Landroid/app/WallpaperManager;)Z
...
.method public static getFlymeDefWallpaper(Landroid/content/Context;Landroid/app/WallpaperManager$FLYME_WALLPAPER_TYPE;)Ljava/io/InputStream;
    ...
    .prologue
    invoke-static {p0}, Landroid/app/FlymeWallpaperManagerInjector;->initColorValue(Landroid/content/Context;)V
    ...
    sget-object v2, Landroid/app/FlymeWallpaperManagerInjector;->mFlymeWallpaperPath:Ljava/lang/String;

    invoke-static {v2}, Landroid/app/FlymeWallpaperManagerInjector;->checkWallpaperPath(Ljava/lang/String;)Z
    ...
    sget-object v3, Landroid/app/FlymeWallpaperManagerInjector;->mFlymeWallpaperPath:Ljava/lang/String;
    ...
    sget-object v2, Landroid/app/FlymeWallpaperManagerInjector;->mFlymeLockWallpaperPath:Ljava/lang/String;
    ...
    sget-object v3, Landroid/app/FlymeWallpaperManagerInjector;->mFlymeLockWallpaperPath:Ljava/lang/String;
