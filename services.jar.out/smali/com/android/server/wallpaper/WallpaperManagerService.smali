...
.method private isFlymeChildrenMode()Z
    ...
    new-instance v0, Lcom/android/server/wallpaper/FlymeChildrenModeToast;

    iget-object v2, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mContext:Landroid/content/Context;

    invoke-direct {v0, v2}, Lcom/android/server/wallpaper/FlymeChildrenModeToast;-><init>(Landroid/content/Context;)V

    .local v0, "childrenModeToast":Lcom/android/server/wallpaper/FlymeChildrenModeToast;
    invoke-virtual {v1, v0}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z
