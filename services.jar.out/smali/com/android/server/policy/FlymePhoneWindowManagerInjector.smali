.class final Lcom/android/server/policy/FlymePhoneWindowManagerInjector;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeHideBootMessage;,
        Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeNavigationBarDarkTheme;,
        Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeShowBootMessage;,
        Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeStatusBarColorTheme;,
        Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeStatusBarDarkTheme;,
        Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeStatusBarEventReceiver;
    }
.end annotation
...
.method static getSlideAnimation(Lcom/android/server/policy/PhoneWindowManager;)Landroid/view/animation/AnimationSet;
    ...
    sget-object v3, Lcom/android/server/policy/FlymePhoneWindowManagerInjector;->mLockScreenBehindEnterInterpolator:Landroid/view/animation/PathInterpolator;
    ...
    sput-object v3, Lcom/android/server/policy/FlymePhoneWindowManagerInjector;->mLockScreenBehindEnterInterpolator:Landroid/view/animation/PathInterpolator;
    ...
    sget-object v4, Lcom/android/server/policy/FlymePhoneWindowManagerInjector;->mLockScreenBehindEnterInterpolator:Landroid/view/animation/PathInterpolator;
...
.method static hideBootMessages(Lcom/android/server/policy/PhoneWindowManager;)Z
    ...
    .prologue
    .line 8338
    new-instance v0, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeHideBootMessage;

    invoke-direct {v0, p0}, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeHideBootMessage;-><init>(Lcom/android/server/policy/PhoneWindowManager;)V

    .line 8339
    .local v0, "hideFlymeBootMessage":Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeHideBootMessage;
...
.method static initFlymeExtraFields(Lcom/android/server/policy/PhoneWindowManager;Landroid/content/Context;)V
    ...
    .line 8319
    new-instance v0, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeStatusBarEventReceiver;

    invoke-direct {v0, p0}, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeStatusBarEventReceiver;-><init>(Lcom/android/server/policy/PhoneWindowManager;)V

    .line 8320
    .local v0, "statusBarEventReceiver":Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeStatusBarEventReceiver;
...
.method static setFlymeStatusBarTheme(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    new-instance v23, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeNavigationBarDarkTheme;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeNavigationBarDarkTheme;-><init>(Lcom/android/server/policy/PhoneWindowManager;ZZ)V
    ...
    new-instance v23, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeStatusBarColorTheme;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeStatusBarColorTheme;-><init>(Lcom/android/server/policy/PhoneWindowManager;IZ)V
    ...
    new-instance v23, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeStatusBarDarkTheme;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeStatusBarDarkTheme;-><init>(Lcom/android/server/policy/PhoneWindowManager;ZZ)V
...
.method static showBootMessage(Lcom/android/server/policy/PhoneWindowManager;Ljava/lang/CharSequence;)Z
    ...
    .prologue
    .line 8332
    new-instance v0, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeShowBootMessage;

    invoke-direct {v0, p0, p1}, Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeShowBootMessage;-><init>(Lcom/android/server/policy/PhoneWindowManager;Ljava/lang/CharSequence;)V

    .line 8333
    .local v0, "showFlymeBootMessage":Lcom/android/server/policy/FlymePhoneWindowManagerInjector$FlymeShowBootMessage;
    iget-object v1, p0, Lcom/android/server/policy/PhoneWindowManager;->mHandler:Landroid/os/Handler;
