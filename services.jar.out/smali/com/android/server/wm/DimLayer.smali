...
.field private mFlymePathInterpolator:Landroid/view/animation/PathInterpolator;
...
.method stepAnimation()Z
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/server/wm/DimLayer;->getFlymeAnimationAlpha(J)F
...
.method private getFlymeAnimationAlpha(J)F
    .locals 7
    .param p1, "curTime"    # J
    ...
    .local v1, "fraction":F
    iget-object v2, p0, Lcom/android/server/wm/DimLayer;->mFlymePathInterpolator:Landroid/view/animation/PathInterpolator;
    ...
    iput-object v2, p0, Lcom/android/server/wm/DimLayer;->mFlymePathInterpolator:Landroid/view/animation/PathInterpolator;

    :cond_0
    iget v2, p0, Lcom/android/server/wm/DimLayer;->mTargetAlpha:F

    iget v3, p0, Lcom/android/server/wm/DimLayer;->mStartAlpha:F

    sub-float v0, v2, v3

    .local v0, "alphaDelta":F
    iget v2, p0, Lcom/android/server/wm/DimLayer;->mStartAlpha:F

    iget-object v3, p0, Lcom/android/server/wm/DimLayer;->mFlymePathInterpolator:Landroid/view/animation/PathInterpolator;
